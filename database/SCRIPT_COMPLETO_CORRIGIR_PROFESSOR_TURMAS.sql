-- =====================================================
-- SCRIPT COMPLETO: Corrigir todas as referências a professor_materias
-- Execute este script no Supabase SQL Editor
-- =====================================================

-- PASSO 1: Remover TODOS os triggers que referenciam professor_materias
DO $$
DECLARE
...
-- PASSO 2: Remover TODAS as funções que referenciam professor_materias
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- PASSO 3: Atualizar a função definir_horarios_agendamento para usar professor_turmas
...
-- PASSO 4: Verificar se o trigger está configurado corretamente
SELECT 
    'Triggers de agendamento' as info,
    trigger_name,
    event_object_table,
    action_timing,
    event_manipulation
...
WHERE event_object_table = 'agendamento'
  AND action_statement LIKE '%definir_horarios_agendamento%'
...
-- PASSO 7: Verificar se há referências restantes a professor_materias
SELECT 
